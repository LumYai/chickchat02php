<?php
    ...
    if(isset($_SESSION['username'])){
        ...
        include'app/helper/conversations.php';
...
<meta charset="UTF-8">
	...
	<title>ChickChat App - Home</title>
        ...
        <div>
            <div class="d-flex mb-3 p-3 bg-light justify-content-between align-items-center ">
                <div class="d-flex align-items-center">
                    <img src="uploads/<?=$user['p_p']?>" alt="image" class="w-25 rounded-circle">
            ...
            <ul id="chatList" class="list-group mvh-50 overflow-auto">
                    ...
                    <?php foreach($conversations as $conversation){ ?>
                        ...
                        <li class="list-group-item">
                            <a href="chat.php?user=<?=$conversation['username']?>" class="d-flex justify-content-between align-items-center p-2">
                                <div class="d-flex align-items-center ">
                                    <img src="uploads/<?=$conversation['p_p']?>" alt="" class="w-10 rounded-circle" style="width: 15%">
                                    <h3 class="fs-xs m-2">
                                        <?=$conversation['name']?>
                                        <!-- <small> <?php 
                ...
                <?php }else{ ?>
                    <div class="alert alert-info text-center" role="alert">
                        <i class="fa fa-comment d-block fs-big " style="font-size: 5rem"></i>
