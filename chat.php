...
<meta charset="UTF-8">
	...
	<title>ChickChat App - Chat</title>
...
<body class="d-flex justify-content-center align-items-center vh-100">
        <div class="w-400 shadow p-4 rounded">
            ...
            <div class="d-flex align-items-center">
                <img src="uploads/<?=$chatWith['p_p']?>" alt="" class="w-15 rounded-circle" style="width: 15%">
            ...
            <div class="input-group mb-3">
                <textarea name=""  cols="3" id="message" class="form-control"></textarea>
